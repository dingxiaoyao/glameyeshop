...
-- 改 ID:改下方的 'G-1NVFCWQ0KL' + push;或者 admin/settings 直接改 + push 空 commit
-- ============================================================
INSERT INTO site_settings (`key`, `value`) VALUES ('ga_measurement_id', 'G-1NVFCWQ0KL')
ON DUPLICATE KEY UPDATE `value` = 'G-1NVFCWQ0KL';
